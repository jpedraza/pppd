...
class db_mysql {
    ...
    */
    function db_mysql($db_host, $db_user, $db_pass, $db_name) {
        ...
        $this->raise_error("No se pudo conectar a la Base de Datos.");
    }
    ...
    */
    ...
    /**
    * Fetches a row from a query result and returns the values from that row as an associative array.
    *
    * @param  string  The query result we are dealing with.
    * @return array
    */
    ...
    */
    function raise_error($error_message = '') {
        ...
        if ($error_message == '') {
            $this->sql = "Error en la consulta SQL:\n\n" . rtrim($this->sql) . ';';
        ...
        die("Parece que hay ciertos problemas con nuestra Base de Datos. Por favor, intentelo mas tarde.<br /><br />\n$message");
    }
}
?>
